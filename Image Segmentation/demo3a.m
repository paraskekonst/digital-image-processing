...
%ektelesi tis myNcuts gia tin prwti eikona gia diafora k 
im1k2=myNCuts(graph1 , 2);
im1k2=reshape(im1k2,50,50);
im1k3=myNCuts(graph1 , 3);
im1k3=reshape(im1k3,50,50);
im1k4=myNCuts(graph1 , 4);
im1k4=reshape(im1k4,50,50);

%ektelesi tis myNcuts gia tin deuteri eikona gia diafora k 
im2k2=myNCuts(graph2 , 2);
im2k2=reshape(im2k2,50,50);
im2k3=myNCuts(graph2 , 3);
im2k3=reshape(im2k3,50,50);
im2k4=myNCuts(graph2 , 4);
